 ...
 * via a NetworkTable
 */
public class LeftLimelightInterface extends SubsystemBase {

  private static LeftLimelightInterface limelight;
  ...
  public static synchronized LeftLimelightInterface getInstance() {
    if (limelight == null) {
      limelight = new LeftLimelightInterface();
    }
    return limelight;
  }
