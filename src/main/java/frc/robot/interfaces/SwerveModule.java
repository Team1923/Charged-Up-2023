...
public class SwerveModule {
    ...
    private void setSpeed(SwerveModuleState desiredState, boolean isOpenLoop){
        if(isOpenLoop){
            ...
            double velocity = Conversions.MPSToFalcon(desiredState.speedMetersPerSecond, Swerve.wheelCircumference, Swerve.driveGearRatio);
    ...
    private Rotation2d getAngle(){
        return Rotation2d.fromDegrees(Conversions.falconToDegrees(mAngleMotor.getSelectedSensorPosition(), Swerve.angleGearRatio));
    }
    ...
    public void resetToAbsolute(){
        double absolutePosition = Conversions.degreesToFalcon(getCanCoder().getDegrees() - angleOffset.getDegrees(), Swerve.angleGearRatio);
    ...
    public SwerveModuleState getState(){
        return new SwerveModuleState(
            Conversions.falconToMPS(mDriveMotor.getSelectedSensorVelocity(), Swerve.wheelCircumference, Swerve.driveGearRatio),
            getAngle()
        );
    }
    ...
    public SwerveModulePosition getPosition(){
        return new SwerveModulePosition(
            Conversions.falconToMeters(mDriveMotor.getSelectedSensorPosition(), Swerve.wheelCircumference, Swerve.driveGearRatio),
            getAngle()
        );
    }
