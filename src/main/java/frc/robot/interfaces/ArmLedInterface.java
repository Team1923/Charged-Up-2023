...
public class ArmLedInterface extends SubsystemBase {

  private static ArmLedInterface ledInterface;
  ...
  public static synchronized ArmLedInterface getInstance() {
    if (ledInterface == null) {
      ledInterface = new ArmLedInterface();
    }
    return ledInterface;
  }

  /** Creates a new LedInterface. */
  public ArmLedInterface() {
