...
public class StateVariables {
    ...
    public static enum IntakeWheelSpeeds{
        ...
        PLOP_HIGH(new IntakeSpeed(-0.35, 0)),// 42 not inflated, 35 for fully inflated
        PLOP_MID(new IntakeSpeed(-0.25, 0)),
        ...
        SHOOT_FRONT_HIGH(new IntakeSpeed(-0.35, 0)),//38 for high inflation
        SHOOT_FRONT_MID(new IntakeSpeed(-0.19, 0)),
    ...
    public static enum IntakePositions {
        ...
        SHOOT_FRONT_HIGH(new ArmAngles(Math.toRadians(58)), new ArmAngles(Math.toRadians(40)), true, () -> false);
