...
public class SwerveDriveCommand extends CommandBase {    
    ...
    public SwerveDriveCommand(SwerveSubsystem s_Swerve, DoubleSupplier translationSup, DoubleSupplier strafeSup, DoubleSupplier rotationSup, BooleanSupplier robotCentricSup) {
