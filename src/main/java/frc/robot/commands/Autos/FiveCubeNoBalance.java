...
public class FiveCubeNoBalance extends SequentialCommandGroup {

  private StateHandler stateHandler = StateHandler.getInstance();
  HashMap<String, Command> eventMap = new HashMap<>();

  /** Creates a new FourCubeWithBalance. */
  public FiveCubeNoBalance(SwerveSubsystem swerve) {

    final AutoFromPathPlanner fiveNoBalance = new AutoFromPathPlanner(swerve, "5CubeAutoNoBalance", 3, 3, false, true, true);
