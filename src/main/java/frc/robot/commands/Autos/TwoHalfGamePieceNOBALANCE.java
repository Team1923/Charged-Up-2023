...
public class TwoHalfGamePieceNOBALANCE extends SequentialCommandGroup {
    /** Creates a new TwoConeLeft. */
    private StateHandler stateHandler = StateHandler.getInstance();

    public TwoHalfGamePieceNOBALANCE(SwerveSubsystem swerve, IntakeSubsystem intake) {

        final AutoFromPathPlanner acquireCone = new AutoFromPathPlanner(swerve, "AcquireConeNOCP", 2.5, 2, false, true,
                true);
        final AutoFromPathPlanner scoreCone = new AutoFromPathPlanner(swerve, "ScoreConeNOCP", 2.5, 2, false, true,
                true);
        final AutoFromPathPlanner acquireSecond = new AutoFromPathPlanner(swerve, "AcquireSecondConeNOCP", 2.5, 2,
                false, true, true);
        ...
        addCommands(
                ...
                new ParallelCommandGroup(
                        new SequentialCommandGroup(
                                new AutoScoreCommand(HorizontalLocations.RIGHT, VerticalLocations.HIGH,
                                        GamePieceMode.CONE),
                                acquireCone),
                ...
                new ParallelCommandGroup(
                        new SequentialCommandGroup(
                                ...
                                new AutoArmToPosition(HorizontalLocations.LEFT, VerticalLocations.HIGH,
                                        GamePieceMode.CONE)),
                        scoreCone),
