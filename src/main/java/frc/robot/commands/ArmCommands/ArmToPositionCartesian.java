...
// public double[] calculateCircleIntersection(double x1, double y1, double r1,
...
// // note if gy == 0 and gx == 0 then the circles are tangent and there is only
// one solution
// // but that one solution will just be duplicated as the code is currently
// written
// if(iy2 >= iy1){
// solutions[0] = ix2;
// solutions[1] = iy2;
...
// double[] intersection = calculateCircleIntersection(0, 0,
// ArmConstants.lengthOfproximal, xPos, yPos, ArmConstants.lengthOfdistal);
...
// if(xPos < 0){
// proximalAngle = Math.PI - Math.asin(intersection[1] /
// ArmConstants.lengthOfproximal);
// distalAngle = Math.PI - Math.asin((yPos-intersection[1]) /
// ArmConstants.lengthOfdistal);
...
// distalAngle = Math.asin((yPos-intersection[1]) /
// ArmConstants.lengthOfdistal);
// }
